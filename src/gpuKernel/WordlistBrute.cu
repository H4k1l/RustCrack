...
extern "C" __global__ void crackWord(char* wordlist, int* wordOffst, int* lenghts, char* hash, int hashtype, int n, bool verbose){
    ...
    if (i < n) {
        ...
        if (hashtype == 0) {
            ...
            hashlen = 32;
            // conversion
            compute_md5_cuda_single(word, inplen, hashWordcmp);
            // ---
        }
        else if (hashtype == 1) {
            // sha-1
            hashlen = 40;
            // conversion
            compute_sha1_cuda_single(word, inplen, hashWordcmp);
            // ---
            ...
            hashlen = 64;
            // conversion
            compute_sha256_cuda_single(word, inplen, hashWordcmp);
            // ---
            ...
            hashlen = 128;
            // conversion
            compute_sha512_cuda_single(word, inplen, hashWordcmp);
            // ---
